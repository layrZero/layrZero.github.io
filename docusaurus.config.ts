...
const config: Config = {
  ...
  organizationName: 'layrZero', // Usually your GitHub org/user name.
  projectName: 'layrZero.github.io', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          rehypePlugins: [rehypeKatex, micromark],
          editUrl:
            'https://github.com/layrZero/layrZero.github.io/tree/main/',
        },
        // blog: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub',
              href: 'https://github.com/layrZero',
            },
          ],
        },
      ],
